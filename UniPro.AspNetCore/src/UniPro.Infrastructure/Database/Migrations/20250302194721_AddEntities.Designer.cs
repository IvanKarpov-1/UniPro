...
namespace UniPro.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250302194721_AddEntities")]
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.Grade", b =>
                {
                    ...
                    b.HasKey("AppId", "StudentId", "TaskId")
                        .HasName("pk_grades");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasIndex("AppId", "TeacherId")
                        .HasDatabaseName("ix_tasks_app_id_teacher_id");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.Grade", b =>
                {
                    b.HasOne("UniPro.Domain.Entities.StudentTask", "StudentTask")
                        .WithOne("Grade")
                        .HasForeignKey("UniPro.Domain.Entities.Grade", "AppId", "StudentId", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_grades_student_tasks_app_id_student_id_task_id");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.StudentInfo", b =>
                {
                    ...
                    b.HasOne("UniPro.Domain.Entities.User", "Student")
                        .WithOne("StudentInfo")
                        .HasForeignKey("UniPro.Domain.Entities.StudentInfo", "AppId", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_infos_users_app_id_student_id");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.StudentTask", b =>
                {
                    ...
                    b.HasOne("UniPro.Domain.Entities.StudentInfo", "Student")
                        .WithMany("StudentTasks")
                        .HasForeignKey("AppId", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_tasks_student_infos_app_id_student_id");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasOne("UniPro.Domain.Entities.TeacherInfo", "Teacher")
                        .WithMany("Tasks")
                        .HasForeignKey("AppId", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tasks_teacher_infos_app_id_teacher_id");
            ...
            modelBuilder.Entity("UniPro.Domain.Entities.TeacherInfo", b =>
                {
                    ...
                    b.HasOne("UniPro.Domain.Entities.User", "Teacher")
                        .WithOne("TeacherInfo")
                        .HasForeignKey("UniPro.Domain.Entities.TeacherInfo", "AppId", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teacher_infos_users_app_id_teacher_id");
